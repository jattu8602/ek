  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        // Debug category and subcategory matching
        debugCategoryMatching(category, subcategory)

        // Create flexible query with multiple category and subcategory formats
        const queryString = createFlexibleQuery(category, subcategory)
